...
//hw4
    ...
    let roll =new Roll(rolls[rollType].imageFile,rolls[rollType].name,rollType,selectedGlaze,selectedQuantity,rolls[rollType].basePrice)
    console.log(roll)
    let savedCart=JSON.parse(localStorage.getItem('cart'))//array of object
    if (savedCart){
        savedCart.push(roll)
    }
    else{
    ...
    // window.location.href='ProductShoppingCart.html'
